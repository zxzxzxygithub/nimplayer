...
abstract class BaseLivePlayer extends VodPlayer {
    ...
    @Override
    public int registerAudioFrameFilterListener(NEAudioPcmConfig config, NELivePlayer.OnAudioFrameFilterListener listener, boolean register) {
    ...
    @Override
    public int registerVideoFrameFilterListener(int format, NELivePlayer.OnVideoFrameFilterListener listener, boolean register){
        if (register && listener == null) {
            return -1;
        }
        if (register) {
    ...
    private int setOnAudioFrameFilterListener() {
        synchronized (lock) {
            ...
            if (audioFrameFilterListener != null ) {
                ...
                LogUtil.info("set on audioFrame filter listener=" + audioFrameFilterListener + ", audioPcmConfig=" + audioPcmConfig);
            } else {
    ...
    private int setOnVideoFrameFilterListener() {
        synchronized (lock) {
            ...
            if (videoFrameFilterListener != null ) {
                ...
                LogUtil.info("set on videoFrame filter listener=" + videoFrameFilterListener + ", videoFormat=" + videoFormat);
            } else {
